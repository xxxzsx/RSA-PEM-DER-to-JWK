const { rsaPemToJwk } = require('./rsaPemDerToJwk')
...
test('rsaPemToJwk browser', () => expect(rsaPemToJwk(pem)).toEqual(jwk))
test('rsaPemToJwk Node.js', () => { atob = btoa = undefined; expect(rsaPemToJwk(pem)).toEqual(jwk) })